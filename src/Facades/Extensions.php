...
class Extensions extends Facade
{
     ...
     * @method static array enableMultiple(array $ids)
     * @method static array disableMultiple(array $ids)
     * @method static \\Illuminate\\Support\\Collection getBroken()
     * @method static \\Illuminate\\Support\\Collection getWithMissingDependencies()
     * @method static \\Illuminate\\Support\\Collection search(string $query)
     * @method static \\Illuminate\\Support\\Collection findByAuthor(string $author)
     * @method static \\Illuminate\\Support\\Collection getReadyToEnable()
     * @method static array checkUpdates()
     * @method static int getTotalSize()
     * @method static \\Illuminate\\Support\\Collection getBySize(bool $desc = true)
